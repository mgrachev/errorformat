...
Note that https://github.com/mgrachev/errorformat doesn't support Vim regex, and `efm-%>` feature (currently).
...
Required fields are self descriptive. See https://godoc.org/github.com/mgrachev/errorformat/fmts#Fmt
